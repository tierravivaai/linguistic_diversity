...
-   **filter_cbd_languages.py** - The script used to filter `glottolog_data.csv` to produce `cbd_party_languages.csv`.
...
## Sample langoid INI File

Below is a sample INI file for a single langoid, West Circassian. 
